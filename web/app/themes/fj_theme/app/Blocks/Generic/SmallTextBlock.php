...
/**
 * Class SmallTextBlock
 * @see https://github.com/wordplate/extended-acf#fields
 * @package App\Admin
 */
class SmallTextBlock extends AbstractBlock
{

    public function __construct()
    {
        parent::__construct([
            'title'       => __('Petit paragraphe de texte'),
            'description' => __("Bloc de texte pouvant servir d'introduction à une page"),
    ...
    {
        yield WysiwygEditor::make(__("Paragraphe"), "text")
            ->tabs('visual')
            ->mediaUpload(false)
            ->required();
    }
